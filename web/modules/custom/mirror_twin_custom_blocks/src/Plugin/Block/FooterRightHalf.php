...
/**
 * Provides a Block for the right side of the footer.
 *
 * @Block(
 *   id = "mirror_twin_right_half",
 *   admin_label = @Translation("Right Half Footer Block")
 * )
 */
class FooterRightHalf extends BlockBase {
