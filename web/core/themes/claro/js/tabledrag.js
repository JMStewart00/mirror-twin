...
(function ($, Drupal, drupalSettings) {
  ...
  $.extend(Drupal.tableDrag.prototype, {
    ...
    makeDraggable: function makeDraggable(item) {
      var self = this;
      var $item = $(item);
      var $firstCell = $item.children('td:first-of-type').wrapInner(Drupal.theme.tableDragCellContentWrapper()).wrapInner($(Drupal.theme('tableDragCellItemsWrapper')).addClass('js-tabledrag-cell-content'));
